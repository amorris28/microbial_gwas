...
\section{Outline}
\begin{enumerate}
  \item First paragraph laying out the problem
  \item BEF research on macroorganisms has demonstrated that productivity increases with
    taxonomic and functional diversity.
  \item This research has been less definitive for microbial communities. There
    are two main hypotheses that aren't very well supported: function should
    scale with community size or abundance of marker genes.
  \item We propose that this BEF approach to linking microbial communities
    to ecosystem function is inappropriate and instead this problem is more
    analagous to the population genetics challenge of linking many genetic
    markers to an organismal phenotype.
  \item To incorporate this idea in to microbial community function research,
